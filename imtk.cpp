...
namespace imtk
{
	...
	void post_window_init(const gui_config& config)
	{
		...
		assign_dynamic_list_icons(config.dynamic_lists.drag_icon, config.dynamic_lists.create_icon, config.dynamic_lists.delete_icon, config.dynamic_lists.clear_icon);
		assign_list_indexer_icons(config.dynamic_lists.create_icon, config.dynamic_lists.delete_icon, config.dynamic_lists.clear_icon);
